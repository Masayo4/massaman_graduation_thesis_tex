...
%[20代~50代へのアンケート調査(n=1,091)で ネット上で知り合った人と直接会った割合は 10~20代で約半数
%株式会社マンダム 出会いとデジタルコミュニケーションにおける調査][1]
%[シャンクレールの調査データを使用][2]
...
\begin{figure}[htbp]
    \begin{center}
       \fbox{\includegraphics[width=100mm,bb=0 0 1130 550]{gap_rate.png}}
    \end{center}
...
\begin{figure}[htbp]
    \begin{center}
       \fbox{\includegraphics[width=100mm,bb=0 0 1132 508]{depress_rate.png}}
    \end{center}
...
%犬の話は削る　表情が似ている人には好意を抱きやすいの仮説立証の話のみにする　（修正）
%似ている人を好きになる　と　顔が似てくるは違う, 並列で並べない　（修正）
